...
public class Train {
    ...
    public void displayTrainDetails(){
        System.out.println("\t========== POJO.Train Details of "+ getTrainName() +" ==========");
            System.out.println("POJO.Train Name      : " + getTrainName());
            System.out.println("POJO.Train ID        : " + getTrainId());
            ...
            System.out.println("----- POJO.Train Path / Stops -----");
