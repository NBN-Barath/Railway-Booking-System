...
public class RBS_Actions {
    ...
    public static void start(){
        ...
        LoginMenu commonActions = new LoginMenu();
        accountsList.add(new AdminAccount("Admin","1","1","1","1",Gender.Male));
        accountsList.add(new UserAccount("2","2","2","2","2",Gender.Male));
...
//                    break;
    ...
    public static void userAction(UserAccount loginAccount,Scanner scanner){
        ...
        System.out.println("==============");
        while (true) {
            System.out.println("1.View POJO.Train \n2.Exit");
            System.out.print("Enter your choice : ");
            int choice = scanner.nextInt();
            switch (choice){
                case 1:
